...
class Eframe:
        ...
        if self.leaders:
            if not any(n in self.leaders for n in day_shift):
                sorted_names = [n for n in sorted_names if n in self.leaders] + \
                               [n for n in sorted_names if n not in self.leaders]
            else:
                sorted_names = [n for n in sorted_names if n not in self.leaders] + \
                               [n for n in sorted_names if n in self.leaders]
        return sorted_names
    ...
    def N(self):
        ...
        for i in range(len(self.main_keys)):
            ...
            while k < self.shift_limit[0]:
                ...
                sorted_names = self._sorted_candidates(self.N_dic[self.main_keys[i]])
    ...
    def PM(self):
        ...
        for i in range(len(self.main_keys)):
            ...
            while k < self.shift_limit[1]:
                ...
                # Sort names by the number of times they've been assigned, ascending
                sorted_names = self._sorted_candidates(self.PM_dic[self.main_keys[i]])
    ...
    def WK(self):
        ...
        for i in range(len(self.week_end)):
            ...
            while k < self.shift_limit[2]:
                ...
                sorted_names = self._sorted_candidates(self.WK_dic[self.week_end[i]])
    ...
    def print(self):
        ...
        '''def attendence_sheet(attendence_day):
